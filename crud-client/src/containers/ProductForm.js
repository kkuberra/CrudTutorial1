  ...
  render() {
    ...
    return <form onSubmit={this.formSubmited}>
        ...
        <div className="form-group">
          ...
          <textarea onChange={this.valueChanged} value={product.description} className="form-control" name="description" id="description" placeholder="Enter a Description" rows="3" required />
        </div>
        <div className="form-group">
